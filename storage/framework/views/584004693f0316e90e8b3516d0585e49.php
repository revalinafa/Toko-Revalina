            ...
            <div class="modal-body">
                <form wire:submit.prevent="store">
                    <div class="form-group">
                        ...
                        <input wire:model="nama_kategori" type="text" class="form-control <?php $__errorArgs = ['nama_kategori'];
...
unset($__errorArgs, $__bag); ?>" placeholder="Masukkan nama kategori">
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['nama_kategori'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
</div><?php /**PATH D:\laragon\www\Toko-Revalina\resources\views/livewire/superadmin/kategori/create.blade.php ENDPATH**/ ?>