<div wire:ignore.self class="modal fade" id="createStokLogModal" tabindex="-1" role="dialog" aria-labelledby="createStokLogModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createStokLogModalLabel">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div class="form-group mt-3">
                        ...
                        <select wire:model="jenis" class="form-control <?php $__errorArgs = ['jenis'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $jenisOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?>" placeholder="Masukkan jumlah stok">
...
</div><?php /**PATH D:\laragon\www\Toko-Revalina\resources\views/livewire/superadmin/stok-log/create.blade.php ENDPATH**/ ?>