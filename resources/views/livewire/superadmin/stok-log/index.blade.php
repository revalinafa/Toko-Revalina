    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1><i class="fas fa-cubes mr-1"></i> {{ $title }}</h1> {{-- Icon untuk Stok Log --}}
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">
                                <i class="fas fa-cubes mr-1"></i> {{-- Icon untuk Stok Log --}}
                                {{ $title }}
                            </li>
                        </ol>
                    </div>
                            ...
                            <tbody>
                                @forelse ($stokLogs as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <button wire:click="edit({{ $item->id }})" class="btn btn-sm btn-warning" data-toggle="modal" data-target="#editStokLogModal">
                                                <i class="fas fa-edit"></i>
                                            </button>
                                            <button wire:click="deleteConfirmation({{ $item->id }})" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#deleteStokLogModal">
        ...
        {{-- Include Modals --}}
        @include('livewire.superadmin.stok-log.create')
        @include('livewire.superadmin.stok-log.edit')
        @include('livewire.superadmin.stok-log.delete')
