<div>
    ...
    <script>
        ...
        $wire.on('showCreateKategoriModal', () => { $('#createKategoriModal').modal('show'); });
        $wire.on('closeCreateKategoriModal', () => { $('#createKategoriModal').modal('hide'); });

        $wire.on('showEditKategoriModal', () => { $('#editKategoriModal').modal('show'); });
        $wire.on('closeEditKategoriModal', () => { $('#editKategoriModal').modal('hide'); });

        $wire.on('closeDeleteKategoriModal', () => { $('#deleteKategoriModal').modal('hide'); });
    </script>
    @endscript
</div>